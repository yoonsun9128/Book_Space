...
EMAIL_CONFIRMATION_AUTHENTICATED_REDIRECT_URL = os.environ.get("EMAIL_CONFIRMATION_AUTHENTICATED_REDIRECT_URL") # 사이트와 관련한 자동응답을 받을 이메일 주소,'webmaster@localhost'
